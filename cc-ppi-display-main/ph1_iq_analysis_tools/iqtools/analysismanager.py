...
class AnalysisManager():
    ...
    def __init__(self, settings = None, data: IQData = None):
        """
    ...
    def importiq(self):
        ...
        self.data.set_importer_settings(self.settings.sample_limit, self.settings.sample_offset)
