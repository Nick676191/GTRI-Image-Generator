from iqtools.importers.iqimporter import IqImporter
...
class IQData():
    ...
    def set_importer_settings(self, samplestoread: int = -1, samplereadoffset: int = 0):
        """
        Configures importer to read subset of samples from file
        """
        if self.importer == None:
            return
        self.importer.samplestoread = samplestoread
        self.importer.samplereadoffset = samplereadoffset
